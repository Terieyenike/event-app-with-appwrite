  ...
  return (
    <Layout>
      <Container>
        ...
        {error && (
            <p className="bg-red-50 p-4 mt-6 rounded max-w-xs mx-auto mb-6">{ error }</p>
          )}
        {!sent && (
        ...
        {sent && <p className='text-center'>Check your email for a magic link!</p>}
      </Container>
    </Layout>
  )
}
